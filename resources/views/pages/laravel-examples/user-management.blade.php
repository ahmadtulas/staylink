<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <x-navbars.sidebar activePage="reservation"></x-navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Reservation"></x-navbars.navs.auth>
        <!-- End Navbar -->
                        ...
                        <div class="card-body px-0 pb-2 ">
                            ...
                            @endif
                                    <div class="row ml-2">
                                        ...
                                        <input type="hidden" value="{{request('pid')}}" name="pId">
